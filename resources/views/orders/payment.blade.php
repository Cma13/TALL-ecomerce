<x-app-layout>
    <div class="container-menu py-8">
        <div class="bg-white rounded-lg shadow-lg px-6 py-4 mb-6">
            <p class="text-gray-700"><span class="font-semibold">Número de pedido: </span>Pedido - {{ $order->id }}
            </p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 flex justify-between items-center">
            ...
            <div class="text-gray-700">
                <p class="text-sm font-semibold">Subtotal: {{ $order->total - $order->shipping_cost }}&euro;</p>
