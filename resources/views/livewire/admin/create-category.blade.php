<div>
    ...
    <x-jet-action-section>
        ...
        <x-slot name="description">
            Aquí encontrará una lista de todas las categorias agregadas
        </x-slot>
    ...
    <x-jet-dialog-modal wire:model="editForm.open">
        ...
        <x-slot name="footer">
            <x-jet-danger-button wire:click="update" wire:loading.attr="disabled" wire:target="editImage, update">Actualizar</x-jet-danger-button>
        </x-slot>
    </x-jet-dialog-modal>
</div>

{{-- editar categorias III --}}
